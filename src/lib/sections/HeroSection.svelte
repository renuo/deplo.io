...
<Background
  video={deploioVideo}
  class="h-[800px]"
  gradient-class="bg-gradient-to-t from-deploio via-80% to-transparent"
  wrapper-class="h-full"
>
  <section class="container relative flex h-full flex-col justify-end space-y-6 pb-16 text-deploio">
