<script lang="ts">
  ...
  const slackMessages = [
    {
      baseDelay: 200,
      name: m.success_story_demokratis_slack_message_name(),
      avatar: samuelAvatar,
      date: m.success_story_demokratis_slack_message_date(),
      content: m.success_story_demokratis_slack_message_text(),
    },
  ];
</script>
